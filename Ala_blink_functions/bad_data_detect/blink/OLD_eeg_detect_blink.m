...
blink_match_kmeans = sbf_1Dclass_kmeans(Dv_sub);
...
% Interpret
blink_match_emgauss_heur = sbf_emgauss_interpret(Dv_sub, mu, sd, P, Arg,...
                                                 'heuristic');
blink_match_emgauss_asymm = sbf_emgauss_interpret(Dv_sub, mu, sd, P, Arg,...
                                                  'asymmetric');
...
switch Arg.classMethod
    case 'kmeans'
        blink_match_tmp = blink_match_kmeans;
    case 'emgauss_heuristic'
        blink_match_tmp = blink_match_emgauss_heur;
    case 'emgauss_asymmetric'
        blink_match_tmp = blink_match_emgauss_asymm;
    otherwise
